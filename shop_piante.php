                            ...
                            <div class="row justify-content-center align-items-center flex-column">
                                ...
                                <div class="col text-center mt-2">
                                    ...
                                    <div class="footer-card d-flex justify-content-center">
                                        ...
                                        <?php else: ?>
                                            <!-- Altrimenti, il bottone "Acquista" apre la pagina del carrello -->
                                            <form action="controller_carrello.php?action=create&id=<?php echo $_SESSION['piante'][$i]['id'] ?>&nome=<?php echo $_SESSION['piante'][$i]['nome'] ?>&prezzo=<?php echo $_SESSION['piante'][$i]['prezzo'] ?>&tipo=<?php echo $_SESSION['piante'][$i]['tipo'] ?>&immagine=<?php echo $_SESSION['piante'][$i]['immagine'] ?>&fileData=<?php echo $_SESSION['piante'][$i]['fileData'] ?>&disp_magazzino=<?php echo $_SESSION['piante'][$i]['disp_magazzino'] ?>" method="post">
