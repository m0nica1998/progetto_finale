            ...
            <div class="col-sm col-md-3 col-lg-3 d-flex flex-column mt-4">
                <div class="header-card d-flex ">
                    ...
                    <div class="text col-8">
                        <p class="fw-bold testo-titolo">Borsa <?php echo $i; ?></p>
                    </div>
                </div>
                <div class="main-card card-equal-height">
                    <div class="row justify-content-center align-items-center flex-column">
                        <div class="col d-flex justify-content-center position-relative">
                            <?php if (in_array($i, [3, 10, 18, 35])): ?>
                                <div class="ribbon bg-green">HOT</div>
                            <?php endif; ?>
                            <?php if (in_array($i, [5, 15, 27, 40])): ?>
                                <div class="ribbon bg-orange">NEW</div>
                            <?php endif; ?>
                            <img src="imgs/borsa<?php echo $i; ?>.JPG" alt="Borsa <?php echo $i; ?>" class="img <?php echo in_array($i, [1, 42]) ? 'opaca' : ''; ?>">
                        </div>
                        <div class="col text-center mt-2">
                            <p class="fw-bold">Prezzo: <?php echo rand(20, 30); ?>€</p>
