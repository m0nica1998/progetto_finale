                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">
                                                            ...
                                                            <button
                                                                ...
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#modalModificaId<?php echo $_SESSION['piante'][$i]['id'] ?>">
                                                                Modifica
                                                            </button>
                                                        ...
                                                        <div
                                                            class="modal fade"
                                                            id="modalModificaId<?php echo $_SESSION['piante'][$i]['id'] ?>"
                                                            tabindex="-1"
                                                            role="dialog"
                                                            aria-labelledby="modalModificaTitleId<?php echo $_SESSION['piante'][$i]['id'] ?>"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="modalModificaTitleId<?php echo $_SESSION['piante'][$i]['id'] ?>">
                                                                            Modifica prodotto
                                                                        </h5>
                                                                        <button
                                                                            type="button"
                                                                    ...
                                                                    <form action="controller_prodotti.php?action=edit&id=<?php echo $_SESSION['piante'][$i]['id'] ?>" method="post">
                                                                        <div class="modal-body">
                                                                            <div class="mb-3">
                                                                                <label for="" class="form-label">Nome</label>
                                                                                <input
